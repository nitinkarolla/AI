...
if __name__ == '__main__':
    ...
    # y = np.array([1, 0, 0, 1])
    nn_r = NeuralNetwork(epochs=10, hiddenLayers=5, neuronsEachLayer=5*[10], learning_rate=0.1)
    # nn_g = NeuralNetwork(epochs=10, hiddenLayers=5, neuronsEachLayer=10, learning_rate=0.1)
    # nn_b = NeuralNetwork(epochs=10, hiddenLayers=5, neuronsEachLayer=10, learning_rate=0.1)
